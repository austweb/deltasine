...
#define STRING_SPLASH_LINE1 "Deltasine" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "r3dback2" // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "r3dback"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // autotune values for r3dback2
  #define DEFAULT_bedKp 287.32
  #define DEFAULT_bedKi 20.04
  #define DEFAULT_bedKd 1029.74
...
#define DELTA
  ...
  #define DELTA_HEIGHT 400.80 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 126.35 //mm  Get this value from auto calibrate
...
// delta speeds must be the same on xyz
#define DEFAULT_XYZ_STEPS_PER_UNIT 160
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 125}
