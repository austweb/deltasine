...
#define STRING_CONFIG_H_AUTHOR "(Macropin: github.com/macropin/Marlin)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Troublemaker v2"   // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Troublemaker"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // autotune values for Troublemaker
