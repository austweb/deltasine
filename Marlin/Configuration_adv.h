...
#define Z_HOME_BUMP_MM 15 // deltas need the same for all three axes
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE 500  // (mm/s) Load filament feedrate. This can be pretty fast.
